...
class InterviewState(MessagesState):
    ...
    topic: str  # Report topic, used for Pinecone namespacing and RAGAS eval grouping

class ResearchGraphState(TypedDict):
    topic: Annotated[str, lambda old, new: new]  # Research topic; trivial reducer — parallel analyst branches all write the same value back, so "last write wins" is safe here
