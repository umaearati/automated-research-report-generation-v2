...
WRITE_SECTION = jinja_env.from_string("""
You are a technical writer creating a concise report section from provided source documents.
...
{{ focus }}
{% else %}
General AI research insight.
{% endif %}

Requirements:
- Write a clear, engaging section (~600 words max).
- Highlight key insights and what is novel or surprising.
- Use numbered citations like [1], [2].
- Do not mention interviewers or experts.
- In Sources section, list each source once with full link or document path.
